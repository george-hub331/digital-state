...
const Body = () => {
  return (
    ...
    <section className="2xl:max-w-[1300px] 2xl:mx-auto 2xl:mt-[60px] 2xl:mb-[80px] 2xl:w-[90%] 2xl:overflow-hidden 2xl:border-box 2xl:pt-[64px] xl:mt-[50px] sm:w-[82%]  w-[90%] overflow-hidden max-w-[1300px] my-auto border-box content-container content-detail-container">
